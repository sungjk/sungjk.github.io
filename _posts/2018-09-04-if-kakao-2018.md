...
개인 Q. Smart Contract 개발 언어는 어떤것으로 할 예정?
개인 Q. Solidity
...
사용자의 password와 카카오페이의 Server-side path phrase를 조합해서 비밀키를 관리한다. 카카오페이 서버를 통해 관리되기 때문에 Brute Force 공격은 원천적으로 막을 수 있음.
